...
## For Customers — Installing an Update

You do not need a GitHub account to download an update.

### What you'll need

- Your Peek-a-Hide connected to your home Wi-Fi
- The customer password that came with your device
- A browser on the same Wi-Fi network as the device
...
4. Scroll down to the **Update Firmware** section and expand it.
...
If the update fails for any reason, the previous version is automatically restored and your device will continue working normally.

---

## Release History

See the [Releases](../../releases) page for the full release history and changelogs.
